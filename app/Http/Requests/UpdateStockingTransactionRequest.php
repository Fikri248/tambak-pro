...
class UpdateStockingTransactionRequest extends FormRequest
{
    ...
    {
        return $this->user()?->canAccess('stocking.update') === true;
    }
    ...
    public function messages(): array
    {
        return [
            ...
            'vendor_id.exists' => 'Vendor yang dipilih tidak tersedia.',
            'batch_code.prohibited' => 'Kode Batch tidak dapat diubah.',
